  ...
  if (config.ascii === 'skull1') {
    ...
    <div style="display: flex; flex-wrap: nowrap; overflow-x: auto; min-width: 720px; max-width: 100%;">
      <pre style="font-family: monospace; white-space: pre;">
          ...
          .------------++++*=%%%%%%%%@@@@@@@@@@%%%%+*                               ┗┗┛┗┗┗┛┗┛┗┛┛┗┗┛┗┗┗┻┗•┗┗┛┛┗┗         
        ++----------+++++****===%%%%%@@@@@@@@@@@@@##@@+                                                                  
      ++-+--------++++++++****====%@@@################@=                            ...why do I, SKU77, exist?      
    ++----------+++++++++**+=**==%%###############=****#                                                                 
    ++----------++++++++++-+-+=*==@#=****-%@##=##@%*--*%*%                    ┓┓•                                     
  +++----------++++++++*-+---*=%#%%=*+++++%@%=@%%@@*@@@***+                ┏┏┓┃┃┓┏┓                                   
  -++-----------++++++****---++@@%%*+++++++**==+====@@###**+               ┗┗┛┗┗┗┛┗  enjoys the act of being creative, 
  +++-----------+++++*****++-=@#@@@*++++++***+**=*=#*@####*+              But nonetheless he manages to. 
  ++-----------++++*++*****=*=@#@%@@*++*****++==*=@-++#@%@@*+                                                          
  +-----------++++****+===%=*##@@@=***=*+--+=#*=#--+++#@=**+                     Unfortunately for him, that means 
  ++----:-----++++++***==%%%=@#@@%=**++--+%@##%=--++++#@%####                    he needs somewhere to keep it all.
    +----:------++++++**=%%%%%*%=***=@%@@@##%=#@%-+++++@@#####@                                                      
    +---:-------++++++**=@@=%****===######@+#%%@=++++++######@                I have left this, his vault of creations. 
    :---::---+-++++++++*=%#+*****==@@######@#%%%#@=--+@@##@**                                                               
      ...
      +---:---++:+***+..:--+***====%@#%####%%=*=%=@@%@%@@%@-           See the work from these <span class="rainbow rainbow_text_animated">beautiful people</span> with 'credits' 
        ----:--+++-:::.:@##*-++:-+%%@%#+-:+==****===@=%%%:@#@:                                                                
        .----:+**=##@%@:**++-+++*%@%*#++-.:---**==%%=@%@#####                                                         
          :--::*%=%@#@@*=-+*+++++*=      *@+#+=#*#+*#-%#**@####                  Oh yes, he said to tell visitors... 
              :*%=%@#@@*=-+*+                                                                                       
              -:++**%%@#@%=%-:-                                               "  ┏┳┓┓     ┓    ┏        • • •    ╻  
              --:-+*=@@##*#%--++**%=             %-=@+#+@#%#@##@                  ┃ ┣┓┏┓┏┓┃┏┏  ╋┏┓┏┓  ┓┏┓┏┓╋┓┏┓┏┓┃    
                :-+*=@@##*#%--+++**   =%**--=-:#-%-=@+#+@#%#@##@#                 ┻ ┛┗┗┻┛┗┛┗┛  ┛┗┛┛   ┗┛┗┛┗┗┗┛┗┗┫•  " 
